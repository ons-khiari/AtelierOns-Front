...
export default function StickersPage() {
  ...
  const allProducts = getProductsByCategory("Stickers")
    ...
    <main className="min-h-screen flex flex-col">
      ...
      <section className="py-12 md:py-16 px-4 bg-muted border-b border-border">
        <div className="max-w-7xl mx-auto">
          <h1 className="font-serif text-4xl md:text-5xl font-bold text-foreground mb-4">Stickers</h1>
          <p className="text-muted-foreground max-w-2xl">
            Aesthetic, vintage-inspired journaling stickers with dark romance themes. Perfect for decorating and
            personalizing your journal pages.
          </p>
        </div>
      </section>
            ...
            <div className="md:col-span-3">
              ...
              {!isLoading && filteredProducts.length === 0 && (
                <div className="col-span-full text-center py-12">
                  <p className="text-muted-foreground">No stickers found in this price range.</p>
                </div>
              )}
            </div>
          </div>
